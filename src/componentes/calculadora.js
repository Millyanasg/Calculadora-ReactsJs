...
export default function Calculadora() {
    ...
    <div className='container'>
        <div className='calculadora'>
            ...
            <Botao label='C' funcao={_limpar}></Botao>
            ...
            <Botao label='+' funcao={_operacao} operacao></Botao>
            <Botao label='1' funcao={_adicionar} span='span-1'></Botao>
            <Botao label='2' funcao={_adicionar} ></Botao>
            <Botao label='3' funcao={_adicionar} ></Botao>

            <Botao label='0' funcao={_adicionar}></Botao>
        
            <Botao label='=' funcao={_operacao} span='span-2'></Botao>
